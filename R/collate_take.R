...
error_by_observation <- ls$all_by_observation

write_rds(error_by_observation, file.path(path, "take_error_by_observation.rds"))
message("\nposterior take error by observation done\n")

take_effort_summary <- ls$all_effort_summary
...
error_by_simulation <- ls$all_by_simulation
...
error_by_simulation_method <- ls$all_by_simulation_method
...
error_by_property <- ls$all_by_property
